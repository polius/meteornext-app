...
def import2(name, globals=None, locals=None, fromlist=(), level=0):
    global importlib
    whitelist = ['traceback','string','re','unicodedata','datetime','zoneinfo','calendar','collections','copy','numbers','math','cmath','decimal','fractions','random','statistics','fnmatch','secrets','csv','time','json','json.decoder','uuid','locale']
