...
class Monitoring:
    ...
    def blueprint(self):
        ...
        @monitoring_blueprint.route('/monitoring/servers', methods=['PUT'])
        @jwt_required
    ...
    def get(self, group_id):
        ...
        if server_id:
            ...
            last_updated = self._monitoring.get_lastupdated(group_id)
            settings = self._monitoring_settings.get(group_id)
            return jsonify({'servers': servers, 'last_updated': last_updated, 'settings': settings}), 200
