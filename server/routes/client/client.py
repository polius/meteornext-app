        ...
        def client_servers_method():
            ...
            if request.method == 'GET':
                ...
                if user['inventory_secured'] and not user['owner']:
                    ...
                    for s in servers:
                        if s['shared']:
                            servers_secured.append({"id": s['id'], "name": s['name'], "region_id": s['region_id'], "region": s['region'], "engine": s['engine'], "version": s['version'], "shared": s['shared'], "region_shared": s['region_shared'], "ssl": s['ssl'], "ssh": s['ssh'], "folder_id": s['folder_id'], "folder_name": s['folder_name']})
                        elif s['region_shared']:
                            servers_secured.append({"id": s['id'], "name": s['name'], "region_id": s['region_id'], "region": s['region'], "engine": s['engine'], "version": s['version'], "hostname": s['hostname'], "port": s['port'], "username": s['username'], "password": s['password'], "ssl": s['ssl'], "ssh": s['ssh'], "shared": s['shared'], "region_shared": s['region_shared'], "folder_id": s['folder_id'], "folder_name": s['folder_name']})
                        else:
        ...
        def client_servers_unassigned_method():
            ...
            if request.method == 'GET':
                ...
                if user['inventory_secured'] and not user['owner']:
                    ...
                    for s in servers:
                        if s['shared']:
                            servers_secured.append({"id": s['id'], "name": s['name'], "region": s['region'], "engine": s['engine'], "version": s['version'], "shared": s['shared'], "region_shared": s['region_shared'], "ssl": s['ssl'], "ssh": s['ssh']})
                        elif s['region_shared']:
                            servers_secured.append({"id": s['id'], "name": s['name'], "region": s['region'], "engine": s['engine'], "version": s['version'], "hostname": s['hostname'], "port": s['port'], "username": s['username'], "password": s['password'], "shared": s['shared'], "region_shared": s['region_shared'], "ssl": s['ssl'], "ssh": s['ssh']})
                        else:
                            servers_secured.append(s)
