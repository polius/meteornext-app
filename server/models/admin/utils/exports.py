class Exports:
    ...
    def get(self, efilter=None, esort=None):
        ...
        query = """
                SELECT e.id, e.mode, e.server_id, e.database, e.size, e.uri, e.status, e.started, e.ended, e.deleted, s.name AS 'server', CONCAT(TIMEDIFF(e.ended, e.started)) AS 'overall', u.username
                FROM exports e
