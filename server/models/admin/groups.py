...
class Groups:
    ...
    def post(self, user_id, group):
        query = """
            INSERT INTO groups (name, description, coins_day, coins_max, coins_execution, inventory_enabled, inventory_secured, deployments_enabled, deployments_basic, deployments_pro, deployments_execution_threads, deployments_execution_timeout, deployments_execution_concurrent, deployments_slack_enabled, deployments_slack_name, deployments_slack_url, monitoring_enabled, monitoring_interval, utils_enabled, utils_import_limit, utils_slack_enabled, utils_slack_name, utils_slack_url, client_enabled, client_limits, client_limits_timeout_mode, client_limits_timeout_value, client_tracking, client_tracking_retention, client_tracking_mode, client_tracking_filter, created_by, created_at)
