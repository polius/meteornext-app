...
class Groups:
    ...
    def post(self, user_id, group):
        query = """
            INSERT INTO groups (name, description, coins_day, coins_max, coins_execution, inventory_enabled, deployments_enabled, deployments_basic, deployments_pro, deployments_execution_threads, deployments_execution_timeout, deployments_execution_concurrent, deployments_expiration_days, deployments_slack_enabled, deployments_slack_name, deployments_slack_url, monitoring_enabled, monitoring_interval, utils_enabled, utils_coins, utils_limit, utils_concurrent, utils_slack_enabled, utils_slack_name, utils_slack_url, client_enabled, client_limits, client_limits_timeout_mode, client_limits_timeout_value, client_tracking, client_tracking_retention, client_tracking_mode, client_tracking_filter, created_by, created_at)
            VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
        """
        return self._sql.execute(query, (group['name'], group['description'], group['coins_day'], group['coins_max'], group['coins_execution'], group['inventory_enabled'], group['deployments_enabled'], group['deployments_basic'], group['deployments_pro'], group['deployments_execution_threads'], group['deployments_execution_timeout'], group['deployments_execution_concurrent'], group['deployments_expiration_days'], group['deployments_slack_enabled'], group['deployments_slack_name'], group['deployments_slack_url'], group['monitoring_enabled'], group['monitoring_interval'], group['utils_enabled'], group['utils_coins'], group['utils_limit'], group['utils_concurrent'], group['utils_slack_enabled'], group['utils_slack_name'], group['utils_slack_url'], group['client_enabled'], group['client_limits'], group['client_limits_timeout_mode'], group['client_limits_timeout_value'], group['client_tracking'], group['client_tracking_retention'], group['client_tracking_mode'], group['client_tracking_filter'], user_id, datetime.utcnow().strftime("%Y-%m-%d %H:%M:%S")))
    ...
    def put(self, user_id, group):
        query = """
            ...
            client_tracking_filter = %s,
            updated_by = %s,
            updated_at = %s
            WHERE id = %s
        """
        self._sql.execute(query, (group['name'], group['description'], group['coins_day'], group['coins_max'], group['coins_execution'], group['inventory_enabled'], group['deployments_enabled'], group['deployments_basic'], group['deployments_pro'], group['deployments_execution_threads'], group['deployments_execution_timeout'], group['deployments_execution_concurrent'], group['deployments_expiration_days'], group['deployments_slack_enabled'], group['deployments_slack_name'], group['deployments_slack_url'], group['monitoring_enabled'], group['monitoring_interval'], group['utils_enabled'], group['utils_coins'], group['utils_limit'], group['utils_concurrent'], group['utils_slack_enabled'], group['utils_slack_name'], group['utils_slack_url'], group['client_enabled'], group['client_limits'], group['client_limits_timeout_mode'], group['client_limits_timeout_value'], group['client_tracking'], group['client_tracking_retention'], group['client_tracking_mode'], group['client_tracking_filter'], user_id, datetime.utcnow().strftime("%Y-%m-%d %H:%M:%S"), group['id']))
