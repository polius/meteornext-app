...
CREATE TABLE `groups` (
  ...
  `client_enabled` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `client_limits` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `client_limits_timeout_mode` INT UNSIGNED NOT NULL DEFAULT '1',
  `client_limits_timeout_value` INT UNSIGNED NOT NULL DEFAULT '10',
  `client_limits_rows` INT UNSIGNED NOT NULL DEFAULT '100000',
...
CREATE TABLE `regions` (
  ...
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `group_id` int(10) unsigned NOT NULL,
  `ssh_tunnel` tinyint(1) UNSIGNED NOT NULL,
...
CREATE TABLE `servers` (
  ...
  `ssl_client_key` MEDIUMTEXT COLLATE utf8mb4_unicode_ci,
  `ssl_client_certificate` MEDIUMTEXT COLLATE utf8mb4_unicode_ci,
  `ssl_ca_certificate` MEDIUMTEXT COLLATE utf8mb4_unicode_ci,
  `ssl_verify_ca` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE `monitoring` (
  ...
  `monitor_enabled` TINYINT(1) UNSIGNED NOT NULL DEFAULT 0,
	`parameters_enabled` TINYINT(1) UNSIGNED NOT NULL DEFAULT 0,
	`processlist_enabled` TINYINT(1) UNSIGNED NOT NULL DEFAULT 0,
  `processlist_active` TINYINT(1) UNSIGNED NOT NULL DEFAULT 0,
	`queries_enabled` TINYINT(1) UNSIGNED NOT NULL DEFAULT 0,
  `date` DATETIME NOT NULL,
...
CREATE TABLE `monitoring_settings` (
  ...
  `monitor_slack_enabled` TINYINT(1) UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE `monitoring_servers` (
  `server_id` INT UNSIGNED NOT NULL,
  `available` TINYINT(1) UNSIGNED NULL,
  `summary` TEXT NULL,
...
CREATE TABLE `imports` (
 ...
 `format` ENUM('.sql','.gz','.tar','.tar.gz') NOT NULL,
 `selected` TEXT NULL,
 `size` BIGINT UNSIGNED NOT NULL,
 `server_id` INT UNSIGNED NOT NULL,
 `database` VARCHAR(191) NOT NULL,
 `create_database` TINYINT(1) UNSIGNED NOT NULL DEFAULT '0',
 `recreate_database` TINYINT(1) UNSIGNED NOT NULL DEFAULT '0',
 `status` ENUM('QUEUED','STARTING','IN PROGRESS','SUCCESS','FAILED','STOPPING','STOPPED') NOT NULL,
 `created` DATETIME NOT NULL,
 `started` DATETIME NULL,
 `ended` DATETIME NULL,
 `updated` DATETIME NULL,
...
CREATE TABLE `clones` (
 ...
 `url` VARCHAR(191) NULL,
 `uri` VARCHAR(191) NULL,
 `progress_export` TEXT NULL,
 `progress_import` TEXT NULL,
 `error` TEXT NULL,
 `stop` TINYINT(1) UNSIGNED NOT NULL DEFAULT '0',
 `user_id` INT UNSIGNED NOT NULL,
 `deleted` TINYINT(1) UNSIGNED NOT NULL DEFAULT '0',
