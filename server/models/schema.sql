...
CREATE TABLE `users` (
  ...
  `mfa_hash` varchar(191) NULL, # pyotp.random_hex() or pyotp.random_base32()
...
CREATE TABLE `monitoring_queries` (
  ...
  INDEX `server_id__last_execution_time` (`server_id`, `last_execution_time`),
  INDEX `server_id__max_execution_time` (`server_id`, `max_execution_time`),
  INDEX `server_id__avg_execution_time` (`server_id`, `avg_execution_time`),
  INDEX `server_id__count` (`server_id`, `count`),
