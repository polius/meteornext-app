...
class Users:
    ...
    def post(self, data):
        self._mysql.execute("INSERT INTO users (username, password, email, group_id, admin) VALUES (%s, %s, %s, %s, %s)", (data['username'], data['password'], data['email'], data['group_id'], data['admin']))
