...
class build_server:
    ...
    def __build_server(self):
        ...
        hidden_imports = ['json','_cffi_backend','bcrypt','requests','pymysql','uuid','flask','flask_cors','flask_jwt_extended','schedule','boto3','socket','paramiko','sshtunnel','unicodedata','secrets','simplejson','csv','itertools','pyotp','flask_compress','gevent','dbutils']
        additional_binaries = []
        binary_name = 'server'
