                  ...
                  <div style="height:calc(100% - 36px)">                  
                    ...
                    <Splitpanes v-show="tabSelected == 'client'" horizontal @ready="initAceClient()">
                      ...
                      <Pane size="50" min-size="0">
                        <ag-grid-vue ref="agGridClient" suppressColumnVirtualisation @grid-ready="onGridReady" @cell-editing-started="cellEditingStarted($event, false)" @cell-editing-stopped="cellEditingStopped($event, false)" @cell-key-down="onCellKeyDown" style="width:100%; height:100%;" class="ag-theme-alpine-dark" rowHeight="35" headerHeight="35" rowSelection="single" :stopEditingWhenGridLosesFocus="true" :columnDefs="clientHeaders" :rowData="clientItems"></ag-grid-vue>
                      </Pane>
                    </Splitpanes>
                    <!--------------->
                    <!-- STRUCTURE -->
...
export default {
  ...
  components: { Splitpanes, Pane, AgGridVue, Content },
  created() {
    this.getServers()
  },
  methods: {
