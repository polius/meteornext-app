<template>
  <div>
    ...
    <div style="height:35px; border-top:2px solid #2c2c2c;">
      ...
      <!-- <v-btn :disabled="sidebarLoading || database.length == 0" @click="bottomBarClick('clone')" text small title="Clone Database" style="height:30px; min-width:36px; margin-top:1px; margin-left:2px; margin-right:2px;"><v-icon small style="font-size:12px;">fas fa-clone</v-icon></v-btn> -->
      <span style="background-color:#424242; padding-left:1px;margin-left:1px; margin-right:1px;"></span>
