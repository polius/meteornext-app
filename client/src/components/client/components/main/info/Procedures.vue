  ...
  <div style="height:100%">
    ...
    <div style="height:calc(100% - 46px)">
      <div style="width:100%; height:100%">
        <v-data-table :loading="sidebarLoadingObject" :headers="infoHeaders.procedures" :items="infoItems.procedures" disable-sort hide-default-footer class="elevation-1" style="margin:10px; background-color:rgb(48,48,48);" mobile-breakpoint="0"></v-data-table>
