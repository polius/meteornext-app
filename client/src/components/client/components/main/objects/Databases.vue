...
export default {
  ...
  watch: {
    tabObjectsSelected(val) {
      this.$nextTick(() => {
        if (val == 'databases') this.resizeTable()
      })
    }
  },
  methods: {
