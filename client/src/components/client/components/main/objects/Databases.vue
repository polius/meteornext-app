...
export default {
  ...
  methods: {
    ...
    contextMenuClicked(item) {
      ...
      else if (item == 'Select All') this.gridApi.objects.databases.selectAll()
      else if (item == 'Deselect All') this.gridApi.objects.databases.deselectAll()
    },
    copySQL() {
      var SqlString = require('sqlstring');
      let selectedRows = this.gridApi.objects.databases.getSelectedRows()
