...
export default {
  ...
  watch: {
    tabObjectsSelected(val) {
      this.$nextTick(() => {
        if (val == 'procedures') this.resizeTable()
      })
    }
  },
  methods: {
