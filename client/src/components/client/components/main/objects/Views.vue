...
export default {
  ...
  methods: {
   onGridReady(params) {
    ...
    resizeTable() {
      var allColumnIds = [];
      this.columnApi.objects.views.getColumns().forEach(function(column) {
