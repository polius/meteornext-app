<template>
  <div style="display:grid; height:100%; align-content:center; text-align:center">
    ...
    <div class="text-h2" style="margin:5px; font-size:3.2rem!important; font-weight:400">Meteor Next</div>
    <!-- <div class="text-h5" style="font-weight:300; margin:5px">v1.0</div> -->
  </div>
</template>
