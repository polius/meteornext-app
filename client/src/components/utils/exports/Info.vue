            ...
            <v-card style="margin-top:10px; margin-left:1px">
              <v-card-text style="padding:15px">
                <div v-if="information_items[0].error != null" class="text-body-1">
                  ...
                  <span v-if="information_items[0].error.startsWith('[CHECK]')">See the <a href="https://docs.meteornext.io/guides/utils.html#requirements-1" target="_blank">requirements</a>.</span>
                </div>
              </v-card-text>
            </v-card>
          </div>
