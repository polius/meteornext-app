            ...
            <v-layout wrap>
              <v-flex xs12>
                <v-form ref="form" @submit.prevent style="margin-top:15px; margin-bottom:15px;">
                  ...
                  <v-autocomplete v-if="filter.by == 'user'" ref="filter_user" v-model="filter.user" v-on:keyup.enter="filterInventory()" filled :items="users" item-value="id" item-text="username" label="User" auto-select-first hide-details style="padding-top:0px; margin-bottom:20px">
                  ...
                  <v-autocomplete v-else-if="filter.by == 'group'" ref="filter_group" v-model="filter.group" v-on:keyup.enter="filterInventory()" filled :items="groups" item-value="id" item-text="name" label="Group" auto-select-first hide-details style="padding-top:0px; margin-bottom:20px"></v-autocomplete>
