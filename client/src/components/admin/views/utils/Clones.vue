...
export default {
  ...
  methods: {
    getClone() {
      ...
      if ('sort' in payload) {
        if (payload['sort']['column'] == 'source_server') payload['sort']['column'] = 'source_server_name'
        else if (payload['sort']['column'] == 'destination_server') payload['sort']['column'] = 'destination_server_name'
