...
export default {
  ...
  methods: {
    getItems() {
      const path = 'http://34.242.255.177:5000/auxiliary'
      axios.get(path)
        .then((res) => {
    ...
    newItem() {
      ...
      this.itemDialogTitle = 'New Auxiliary Connection'
      this.itemDialog = true
    },
    editItem() {
      this.mode = 'edit'
      this.item = JSON.parse(JSON.stringify(this.selected[0]))
      this.itemDialogTitle = 'Edit Auxiliary Connection'
      this.itemDialog = true
    },
    deleteItem() {
      this.mode = 'delete'
      this.itemDialogTitle = 'Delete Auxiliary Connection'
      this.itemDialog = true
    },
    actionConfirm() {
