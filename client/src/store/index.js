...
export default new Vuex.Store({
  state: {
    ...
    inventory_enable: localStorage.getItem('inventory_enable') == '1' ? true : false,
  ...
  mutations: {
    auth(state, data) {
      ...
      state.inventory_enable = data.inventory_enable == 1
        ...
        axios.post('/login', user)
          .then(response => {
            var data = { 
              ...
              inventory_enable: response.data.data.inventory_enable,
            ...
            localStorage.setItem('inventory_enable', data['inventory_enable'])
          ...
          .catch(error => {
            ...
            localStorage.removeItem('inventory_enable')
  ...
  getters: {
    ...
    inventory_enable: state => state.inventory_enable,
